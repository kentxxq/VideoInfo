...
class Jpeg(KaitaiStruct):
    ...
    class SegmentSos(KaitaiStruct):
        ...
        def _read(self):
            ...
            for i in range(self.num_components):
                self.components[i] = self._root.SegmentSos.Component(
    ...
    class SegmentApp1(KaitaiStruct):
        ...
        def _read(self):
            self.magic = (self._io.read_bytes_term(0, False, True, True)).decode(
                u"ASCII"
            )
            _on = self.magic
            if _on == u"Exif":
    ...
    class SegmentSof0(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.components = [None] * (self.num_components)
            for i in range(self.num_components):
                self.components[i] = self._root.SegmentSof0.Component(
                    self._io, self, self._root
                )
        ...
        class Component(KaitaiStruct):
            ...
            def sampling_x(self):
                if hasattr(self, "_m_sampling_x"):
                    return (
                        self._m_sampling_x if hasattr(self, "_m_sampling_x") else None
                    )
            ...
            def sampling_y(self):
                if hasattr(self, "_m_sampling_y"):
                    return (
                        self._m_sampling_y if hasattr(self, "_m_sampling_y") else None
                    )
    ...
    class SegmentApp0(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.thumbnail = self._io.read_bytes(
                ((self.thumbnail_x * self.thumbnail_y) * 3)
            )
